      ...
      <main className="flex items-center text-black w-full min-h-screen  bg-blue-gradient  ">
        <Layout className={`py-24 lg:px-32 sm:px-8 md:px-12 `}>
          ...
          >
            ...
            <div className=" w-full px-3 md:px-0 md:w-1/2 flex flex-col items-center self-center  h-[100%] ">
              <AnimatedText
                text={" I am a full stack developer"}
                className=" sm:py-2 md:py-7 md:!text-6xl !text-5xl !text-left pl-0"
              />
              ...
              <div className="flex items-center self-start gap-x-4 mb-5 md:mb-0">
                <Link
                  href="/dummy.pdf"
                  target={"_blank"}
                  download={true}
